...
/// <summary>Test double that always reports every member as unavailable, without ever needing a real Dataverse connection to prove it (DataversePool must short-circuit before calling member.AcquireAsync when FailFast is configured).</summary>
